...
public class EnderchestCommand implements CommandExecutor {
    ...
    public void viewOnlyEC(Player p) {
        ...
        Menu menu = ChestMenu.builder(5).title(StyleManager.get().getPrimaryColor() + "Эндер-сундук (Только просмотр)").build();
...
//        установка предметов из эндер-сундука в инвентарь меню
